...
export default function Header() {
  ...
  return (
    <header className="sticky top-0 z-[100] bg-(--bg)/40 backdrop-blur-lg border-b border-border/40">
      ...
      {/* Mobile Menu Sheet - Fixed to sit below header */}
      <Sheet open={isMobileMenuOpen} onOpenChange={setIsMobileMenuOpen}>
        <SheetContent
          side="right"
          className="!top-16 !h-[calc(100vh-64px)] !border-r border-border/40 shadow-xl w-full sm:max-w-sm z-[90]"
        >
