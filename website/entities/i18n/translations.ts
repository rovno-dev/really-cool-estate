...
export const translations: Record<Language, Record<string, string>> = {
  ...
  ru: {
    ...
    "search.minFloor": "Этаж от",
    "search.maxFloor": "Этаж до",
    "search.yearFrom": "Год от",
    "search.yearTo": "Год до",
    "search.parking": "Парковка",
    "search.furnished": "Мебель",
    "search.mortgage": "Ипотека",
